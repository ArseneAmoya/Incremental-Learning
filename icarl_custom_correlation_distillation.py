...
def main():
    ...
    for task_idx, (train_dataset, task_info) in enumerate(protocol):
        ...
        metrics_df.to_csv('metrics_custom_corrdist.csv', index=False)
        ...
        losses_df.to_csv('losses_custom_corrdist.csv', index=False)
        time_df.to_csv('time_custom_corrdist.csv', index=False)
